...
public final class HelloRequestHandler implements HttpAsyncRequestHandler<HttpRequest> {
    ...
    public void handle(final HttpRequest request, final HttpAsyncExchange httpexchange, final HttpContext context) {
        HttpGet httpGet = new HttpGet("http://localhost:" + Parameters.SERVER_PORT + "/slowhello");
        ...
        FutureCallback<HttpResponse> responseCallback = new FutureCallback<HttpResponse>() {
            ...
            public void completed(final HttpResponse httpClientResponse) {
                try {
                    ...
                    response.setEntity(new NStringEntity(result, ContentType.create("text/html", "UTF-8")));
    ...
    private void sendError(Exception e, HttpAsyncExchange httpexchange) {
        ...
        response.setEntity(new NStringEntity(stringWriter.toString(), ContentType.create("text/plain", "UTF-8")));
        httpexchange.submitResponse();
    }
}
